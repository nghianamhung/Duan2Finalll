...
import static com.example.khangit.project_group3.ultil.Server.Duongdanlogin;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void loginAccount(final String username, final String password) {
        ...
        if (checkEditText(edtUserName) && checkEditText(edtPassWord)) {
            pDialog.show();
            StringRequest requestLogin = new StringRequest(Request.Method.POST, Duongdanlogin,
